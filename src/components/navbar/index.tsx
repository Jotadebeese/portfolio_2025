...
export default function Navbar() {
  return (
    <div className="pointer-events-none fixed z-30 flex w-full justify-center">
      <div className="flex w-full max-w-6xl justify-end pt-2 pr-2.5 sm:pr-5">
        <div className="pointer-events-auto group hover:shadow-foreground rounded-full transition-all duration-500 ease-in-out hover:shadow-[-4px_-4px]">
