  ...
  return (
    <>
      <div
        ...
        className={clsx(
          "bg-foreground fixed inset-0 transition-all duration-300 ease-in-out",
          {
            "pointer-events-auto z-40 opacity-40": open,
            "pointer-events-none z-[-1] opacity-0": !open,
          },
        )}
      ></div>
      <footer className="pointer-events-none fixed right-0 bottom-0 left-0 z-50 flex w-full transform-gpu flex-col items-center justify-center px-2 pb-[max(1rem,calc(env(safe-area-inset-bottom)+0.5rem))] will-change-transform sm:pb-4">
        <div
          ref={ref}
          ...
          <div className="flex w-full items-center justify-between">
            ...
            <div className="flex flex-1 items-center justify-end">
              <button
                ...
                className="bg-foreground text-background group hover:bg-utils-scent-orange relative z-10 flex h-9 w-9 cursor-pointer items-center justify-center overflow-hidden rounded-lg transition-all duration-300 ease-in-out"
              >
                {!open ? (
                  <>
