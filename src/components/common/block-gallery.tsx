            ...
            <div key={item.id || index} className="break-inside-avoid mb-4">
              <div className="relative rounded-lg overflow-hidden flex flex-col">
                <Image
                  ...
                  className="w-full h-auto object-cover bg-foreground/5"
  ...
  if (layout === "carousel") {
    return (
      <div className="relative group w-full">
        <button
          onClick={() => scroll("left")}
          className="absolute left-2 top-1/2 -translate-y-1/2 z-10 bg-background/80 p-2 rounded-full shadow-md opacity-0 group-hover:opacity-100 transition-opacity hidden md:block hover:bg-background"
        ...
        >
          {images.map((item, index) => {
            ...
            return (
              <div
                key={item.id || index}
                className="snap-center shrink-0 w-[85%] md:w-[60%] flex flex-col"
              >
        ...
        <button
          ...
          className="absolute right-2 top-1/2 -translate-y-1/2 z-10 bg-background/80 p-2 rounded-full shadow-md opacity-0 group-hover:opacity-100 transition-opacity hidden md:block hover:bg-background"
